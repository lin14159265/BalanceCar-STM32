...
void Timer_Init(void){
	...
	TIM_TimeBaseInitStructure.TIM_Period = 20 - 1;				//计数周期，即ARR的值
	TIM_TimeBaseInitStructure.TIM_Prescaler = 36000	- 1;				//预分频器，即PSC的值  10ms执行一次
...
/**void TIM1_UP_IRQHandler(void){//定时器中断函数，可以复制到使用它的地方
