...
void MPU6050_Init(void){//(PB10,PB11)
	...
	MPU6050_WriteReg(MPU6050_SMPLRT_DIV, 0x00);				//采样率分频寄存器，配置采样率 1000HZ
	MPU6050_WriteReg(MPU6050_CONFIG, 0x06);					//配置寄存器，配置DLPF
	MPU6050_WriteReg(MPU6050_GYRO_CONFIG, 0x00);			//陀螺仪配置寄存器，选择量程为±250°/s
...
void MPU6050_Angle_Init(void){//获得初始角度值
	MPU6050_GetData(&ax, &ay, &az, &gx, &gy, &gz);//读取MPU6050的数值(频率:1000HZ,加速度量程:±4g,角速度量程±250°/s
